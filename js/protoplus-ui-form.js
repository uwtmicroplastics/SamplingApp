...
Protoplus.ui = {
    ...
    spinner: function(element, options){
        ...
        options = Object.extend({
            ...
            value:false,
            size: 5,
            iconPath: '/assets/img/builder/flat_arrow.svg',
        ...
        // button Styles
        var buttonStyles = { height:'50%', width:'20px', position:'relative', background:'#E6E7EA', boxSizing:'border-box'};
        var imgStyles = { width:'8px', height:'6px', position:'absolute', margin:'-3px 0 0 -4px', top:'50%', left: '50%' };
        ...
        arrowCont.insert(upTD = new Element('div', {className: 'form-spinner-up'}).insert(upArrow = new Element('img', {src:options.iconPath, alt:'up arrow'})));
        // Construct the down arrow
        arrowCont.insert(downTD = new Element('div', {className: 'form-spinner-down'}).insert(downArrow = new Element('img', {src:options.iconPath, style:'transform: rotate(180deg);', alt:'down arrow'})));

        spinnerTable.setStyle({border:'1px solid #ccc', display:'inline-block', background:'#fff', maxWidth:'180px', position:'relative', width:'100%', paddingRight:'20px', boxSizing:'border-box' });
        upArrow.setStyle(imgStyles);
        downArrow.setStyle(imgStyles);
        upTD.setStyle(buttonStyles);
        downTD.setStyle(buttonStyles);
        arrowCont.setStyle({position:'absolute', right:0, top:0, height:'100%'});
        element.setStyle({width:'100%', border:'none', boxSizing:'border-box', textAlign:'right', outline:'none'});
